...
Agradeço ao professor Rodolpho e ao professor Clenilton pela orientação, pela disponibilidade e pelo conhecimento compartilhado ao longo deste trabalho e do curso. A dedicação de vocês foi fundamental para que este projeto se tornasse realidade. 
...
Por fim, agradeço a todas as pessoas que de alguma forma passaram pela minha vida e deixaram algo. Cada encontro, cada conversa e cada experiência contribuiu para quem eu sou hoje e para chegar até aqui. 
...
The development of materials for rechargeable batteries has attracted increasing interest due to the expansion of energy storage devices and the growing demand for more efficient and sustainable technologies. In this context, **Impedance Spectroscopy (IS)** is one of the main techniques used to characterize solid electrolytes for rechargeable batteries, enabling the determination of properties such as ionic conductivity. However, the interpretation of impedance spectra and the selection of the most appropriate equivalent circuit for data fitting still rely largely on the researcher's expertise, making this process time-consuming and subject to subjective interpretation. To address this challenge, this work proposes the application of **Artificial Intelligence (AI)** techniques to automate the classification of impedance spectra.
For model training, a database composed of synthetic spectra was developed using different equivalent circuit models and combinations of the parameter values of their constituent elements. Initially, **Deep Learning (DL)** models were evaluated, and the results highlighted the importance of the data preprocessing stage. After spectrum normalization, a significant improvement in classification accuracy was observed. Subsequently, different **Machine Learning (ML)** algorithms were implemented and compared, demonstrating superior performance for the dataset considered in this study. Hyperparameter optimization further improved the classification capability of the models.
The obtained results demonstrate that **Machine Learning** techniques represent a promising approach for supporting the automatic identification of the equivalent circuit associated with impedance spectra, reducing both the analysis time and the subjectivity of the process. As future work, the incorporation of noise into the synthetic spectra, the expansion of the database to include different frequency ranges, and the evaluation of the proposed models using experimental data are envisaged. It is expected that the proposed methodology will contribute to accelerating the characterization of materials and the development of new solid electrolytes and electrodes for rechargeable batteries, making the research process more efficient and reliable.
